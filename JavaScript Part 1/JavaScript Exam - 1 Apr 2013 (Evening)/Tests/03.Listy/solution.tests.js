...
let solve = require('./solution').solve;
...
describe("Test Listy", () => {
    it("Zero Test #1", () => {
        ...
        expect(solve(args)).to.be.equal(42);
    });
    ...
    it("Zero Test #2", () => {
        ...
        expect(solve(args)).to.be.equal(111);
    });
    ...
    it("Test #1", () => {
        ...
        expect(solve(args)).to.be.equal(2141962);
    });
    ...
    it("Test #2", () => {
        let args =
            ["def test0[1]",
                ...
                "[test299]                 "];
        expect(solve(args)).to.be.equal(5644);
    });
    ...
    it("Test #3", () => {
        ...
        expect(solve(args)).to.be.equal(281);
    });
    ...
    it("Test #4", () => {
        ...
        expect(solve(args)).to.be.equal(2000000000);
    ...
    it("Test #5", () => {
        ...
        expect(solve(args)).to.be.equal(1119);
    });
    ...
    it("Test #6", () => {
        ...
        expect(solve(args)).to.be.equal(-6475118);
    });
    ...
    it("Test #7", () => {
        ...
        expect(solve(args)).to.be.equal(134216704);
    });

    it("Test #8", () => {
        let args = [
            "def hmfunc     [123, 654, 1234, 64]",
            "def hm2 sum[hmfunc]",
            "def hm22 min[hm2]",
            "max[                 1,              hm22          ]",
        ];
        ...
        expect(solve(args)).to.be.equal(2075);
    });
    ...
    it("Test #9", () => {
        ...
        expect(solve(args)).to.be.equal(6008);
    });
    ...
    it("Test #10", () => {
        ...
        expect(solve(args)).to.be.equal(57);
    });
    ...
    it("Test #11", () => {
        ...
        expect(solve(args)).to.be.equal(79843);
    });
    ...
    it("Test #12", () => {
        ...
        expect(solve(args)).to.be.equal(947500);
    });
